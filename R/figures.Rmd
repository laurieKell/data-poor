...
```{r, trend}
trnd=bbmsy[,c("biomass","bd","bd4","sra","dan")]
...
dt1=melt(subset(bbmsy[,c(1:5,7)],biomass>=1.2),id=c("assessid","year"))
...
dt1=melt(subset(bbmsy[,c(1:5,7)],biomass>=0.8),id=c("assessid","year"))
